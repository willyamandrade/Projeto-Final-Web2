...
urlpatterns = [
    path('painel/ilha/<ilha_id>', views.painel, name='painel'),
    ...
    path('todos_mii', views.todos_mii, name='todos_mii'),
    path('detalhes_mii/ilha/<ilha_id>/mii/<id>', views.detalhes_mii, name='detalhes_mii')
]
